...
designed for easier extensibility and per snippet parametrization. Motivations are **support for directly referencing C# symbols** like methods and **importing BenchmarkDotNet results**
